  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
  ...
  double delta_secs = period.seconds();

  float pos_prev_l = wheel_l_.pos;
  wheel_l_.pos = wheel_l_.calc_enc_angle();
  wheel_l_.vel = (wheel_l_.pos -pos_prev_l) / delta_secs;
  
  float pos_prev_r = wheel_r_.pos;
  wheel_r_.pos = wheel_r_.calc_enc_angle();
  wheel_r_.vel = (wheel_r_.pos -pos_prev_r) / delta_secs;
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  int motor_r_counts_per_loop = wheel_l_.cmd / wheel_r_.rads_per_count / cfg_.loop_rate;

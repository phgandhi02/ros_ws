...
class DiffBotSystemHardware : public hardware_interface::SystemInterface
{
  ...
  private:
    ...
    ArduinoComms comms_; // declaring the comms_ var which will hold the object which will connect, disconnect, read, and write.
    Config cfg_; // here I am declaring the config parameter which I will fill out in the implementation.
    Wheel wheel_l_;
    Wheel wheel_r_;
};
